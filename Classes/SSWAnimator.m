...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    if (fromVCHidesBottomBar && tabBar && (tabBarControllerContainsToViewController || (isToViewControllerFirstInNavController && tabBarControllerContainsNavController))) {
        ...
        [[transitionContext containerView] insertSubview:tabBar belowSubview:fromViewController.view];
        tabBar.transform = CGAffineTransformMakeTranslation(toViewControllerXTranslation, 0);
